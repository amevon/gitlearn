...
{   
    ...
    {
        if ($totalItems < 0) {
        $this->errorLog[] = "totalItems must be not negative value";
		return false;
        }
    ...
    {
        if ($page < 1) {
             $this->errorLog[] = "page must be positive integer value";
			 return false;
        }
        $this->page = (int) $page;
    ...
    {
        if ($itemsPerPage < 1) {
         $this->errorLog[] =  "itemsPerPage must be positive integer value";
		 return false;
        }
    ...
    {
        if ($proximity < 0) {
          $this->errorLog[] = "proximity must be non negative value";
		  return false;
        }
	...
	{
		return (!empty($this->errorLog))? implode("<br/>", $this->errorLog):'';
	}
	
}
//https://github.com/SugiPHP/Pagination